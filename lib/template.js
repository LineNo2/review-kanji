...
module.exports = {
  ...
  list: function (section_number, result_date) {
    var list = '<h1 style="text-align:center;font-size:10vw;"><a href="/" style="color: white">漢字勉強</a></h1><table class="list" style="width:50vw;box-shadow: 5px 5px 5px 5px rgba(0, 0, 0, 0.3);font-size:5vw;margin:auto;text-align: center;"><tr class="list" style="background:#111114"><th class="list" colspan=3 style="color: white;">SECTION</th></tr>';
...
</form></div><table id="kanji_table" style="width:50vw;box-shadow: 5px 5px 5px 5px rgba(0, 0, 0, 0.3);font-size:5vw;margin:auto;text-align: center;">
